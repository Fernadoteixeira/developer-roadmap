...
- [@official@Netlify Documentação](https://docs.netlify.com/platform/primitives/#functions)
- [@article@Introduzindo as Funções Netlify 2.0](https://www.netlify.com/blog/introducing-netlify-functions-2-0/)
- [@video@Como Implantar um Site no Netlify](https://www.youtube.com/watch?v=0P53S34zm44)
- [@feed@Daily.dev Feed do Netlify](https://app.daily.dev/tags/netlify)
