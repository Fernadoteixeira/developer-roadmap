...
O cache LRU é um cache que despeja primeiro o item usado menos recentemente. É um algoritmo de cache muito comum. Ele é usado em muitos lugares, como no cache do navegador, no cache do banco de dados e no cache do sistema operacional.
