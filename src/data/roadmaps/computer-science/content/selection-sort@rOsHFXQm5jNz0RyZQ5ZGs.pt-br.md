...
A classificação por seleção é um algoritmo de classificação que seleciona o menor item não classificado na lista e o troca pelo índice 0, depois encontra o próximo menor e o coloca no índice 1 e assim por diante.
