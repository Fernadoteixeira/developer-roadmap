...
Um quadro Kanban é uma ferramenta ágil de gerenciamento de projetos projetada para ajudar a visualizar o trabalho, limitar o trabalho em andamento e maximizar a eficiência.

Visite os seguintes recursos para saber mais:

- [@article@Kanban - Uma breve introdução](https://www.atlassian.com/agile/kanban)
- [@article@Modelo Kanban em Engenharia de Software](https://www.guru99.com/kanban-cards-boards-methodology.html)
